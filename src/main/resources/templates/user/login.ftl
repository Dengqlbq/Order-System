...
<link href="/order_system/css/login_style.css" rel='stylesheet' type='text/css' />
<!--webfonts-->
...
<div class="login-form">
	<div class="close"> </div>
		<div class="head-info">
			...
			<div class="clear"> </div>
	<div class="avtar">
		<img src="/order_system/images/avtar.png" />
	</div>
			<form method="post" action="/order_system/seller/user/login">
